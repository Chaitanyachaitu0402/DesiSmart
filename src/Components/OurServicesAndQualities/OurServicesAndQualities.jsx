...
import qualityMan from "../../assets/man.png";
...
const OurServicesAndQualities = ({ children }) => {
    ...
    return (
        <section id={!isOurQuality ? "services" : ''}
            style={isOurQuality ? { backgroundImage: `url(${ourQualitiesBg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' } : isService ? { backgroundColor: 'white' } : {}} className="md:h-[71vh]">
            <Container>
